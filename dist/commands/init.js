 ...
 */
export async function ensureFrameworkRepo(options) {
...
export async function readAppTemplates(frameworkDir) {
...
export async function selectAppTemplates(templates) {
    const answer = await inquirer.prompt([
        {
            type: "checkbox",
...
export async function promptAppNames(selectedTemplates) {
 ...
 */
export async function copySelectedApps(frameworkDir, targetDir, appNames) {
