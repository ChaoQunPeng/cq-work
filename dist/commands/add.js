...
import { copySelectedApps, ensureFrameworkRepo, promptAppNames, readAppTemplates, selectAppTemplates, } from "./init.js";
/**
 * 执行 `cq-work add app` 的完整业务流程。
 * 每次执行都会同步模板仓库，确保用户选择的是 GitHub 上的最新 app 模板。
 * CLI 默认以执行命令的当前目录为目标，测试可显式传入业务项目目录。
 */
export async function runAddAppCommand(options) {
 ...
 */
async function assertBusinessProject(projectDir) {
